...
export function Iphone({ children, className = '' }: { children?: React.ReactNode; className?: string }) {
    return (
        <div className="flex items-center justify-center">
            <div className={`relative rounded-3xl border border-neutral-700 bg-black shadow-md overflow-hidden box-border max-w-full max-h-full ${className || 'w-[320px] h-[640px]'} `}>
                {/* screen (reduced frame thickness) */}
                <div className="absolute inset-2 rounded-2xl bg-surface overflow-hidden">
