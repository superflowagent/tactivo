-- Migration: remove support for auth.user fallback in events triggers
-- After ensuring frontend sends canonical profile.id for event attendees, simplify triggers
