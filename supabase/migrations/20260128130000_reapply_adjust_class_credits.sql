-- Reapply: ensure adjust_class_credits_on_events_change looks up profiles by id OR user
-- This migration forcibly replaces the trigger function to ensure no missing alias issues
