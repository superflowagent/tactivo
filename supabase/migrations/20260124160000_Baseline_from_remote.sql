...
CREATE POLICY "Company members can delete" ON "public"."anatomy" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can delete" ON "public"."equipment" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can delete" ON "public"."exercises" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can delete" ON "public"."program_exercises" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
...
CREATE POLICY "Company members can insert" ON "public"."anatomy" FOR INSERT WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
  WHERE ("p"."user" = "auth"."uid"())
 LIMIT 1)));
...
CREATE POLICY "Company members can insert" ON "public"."equipment" FOR INSERT WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
  WHERE ("p"."user" = "auth"."uid"())
 LIMIT 1)));
...
CREATE POLICY "Company members can insert" ON "public"."exercises" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "exercises"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));
...
CREATE POLICY "Company members can insert" ON "public"."program_exercises" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."company" = "p"."company")))
  WHERE (("p"."user" = "auth"."uid"()) AND ("prog"."id" = "program_exercises"."program") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));
...
CREATE POLICY "Company members can select" ON "public"."anatomy" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "anatomy"."company")))));
...
CREATE POLICY "Company members can select" ON "public"."equipment" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "equipment"."company")))));
...
CREATE POLICY "Company members can select" ON "public"."exercises" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can select" ON "public"."program_exercises" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."company" = "p"."company")))
...
CREATE POLICY "Company members can update" ON "public"."anatomy" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "anatomy"."company"))))) WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
  WHERE ("p"."user" = "auth"."uid"())
 LIMIT 1)));
...
CREATE POLICY "Company members can update" ON "public"."equipment" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "equipment"."company"))))) WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
  WHERE ("p"."user" = "auth"."uid"())
 LIMIT 1)));
...
CREATE POLICY "Company members can update" ON "public"."exercises" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "exercises"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "exercises"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));
...
CREATE POLICY "Company members can update" ON "public"."program_exercises" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."company" = "p"."company")))
  WHERE (("p"."user" = "auth"."uid"()) AND ("prog"."id" = "program_exercises"."program") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."company" = "p"."company")))
  WHERE (("p"."user" = "auth"."uid"()) AND ("prog"."id" = "program_exercises"."program") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));
...
CREATE POLICY "Company members can update" ON "public"."programs" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "programs"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = "auth"."uid"()) AND ("p"."company" = "programs"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));
...
DROP POLICY IF EXISTS "Select company for members" ON public."companies";
...
DROP POLICY IF EXISTS "Update owner or company" ON public."events";
...
CREATE POLICY "anatomy_select_company" ON "public"."anatomy" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "anatomy_write_company" ON "public"."anatomy" USING ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "anatomy"."company")))))) WITH CHECK ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
DROP POLICY IF EXISTS "companies_update_professional" ON public."companies";
...
DROP POLICY IF EXISTS "company_resource_select" ON public."exercises";
CREATE POLICY "company_resource_select" ON "public"."exercises" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."company" = "exercises"."company")))));



DROP POLICY IF EXISTS "company_resource_write" ON public."exercises";
CREATE POLICY "company_resource_write" ON "public"."exercises" USING ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "exercises"."company")))))) WITH CHECK ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."role" = 'professional'::"text"))))));



DROP POLICY IF EXISTS "delete_classes_templates_by_professional" ON public."classes_templates";
...
CREATE POLICY "equipment_select_company" ON "public"."equipment" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."company" = "equipment"."company")))));



DROP POLICY IF EXISTS "equipment_write_company" ON public."equipment";
CREATE POLICY "equipment_write_company" ON "public"."equipment" USING ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "equipment"."company")))))) WITH CHECK ((("auth"."role"() = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = "auth"."uid"()) AND ("p"."role" = 'professional'::"text"))))));
...
DROP POLICY IF EXISTS "events_delete_professional_or_service" ON public."events";
...
DROP POLICY IF EXISTS "events_insert_professional_or_service" ON public."events";
...
DROP POLICY IF EXISTS "events_policy_delete" ON public."events";
...
DROP POLICY IF EXISTS "events_policy_insert" ON public."events";
...
DROP POLICY IF EXISTS "profiles_policy_delete_admins" ON public."profiles";
...
DROP POLICY IF EXISTS "profiles_update_admins_or_professionals" ON public."profiles";
...
DROP POLICY IF EXISTS "profiles_update_self_or_service" ON public."profiles";
...
COMMENT ON POLICY "select_classes_templates_by_company" ON "public"."classes_templates" IS 'Allow users in the same company to select class templates';
...
COMMENT ON POLICY "select_events_by_company_and_role" ON "public"."events" IS 'Allow professionals to see company events; clients see company classes or appointments where they are attendees';
...
COMMENT ON POLICY "update_classes_templates_by_professional" ON "public"."classes_templates" IS 'Allow professionals to update class templates for their company';
...
-- Ensure explicit SET search_path for known SECURITY DEFINER functions (idempotent, safe if missing)
DO $$ BEGIN
  BEGIN ALTER FUNCTION public.accept_invite(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.accept_invite(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.accept_invite_debug(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.accept_invite_http(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.accept_invite_verbose(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.adjust_class_credits_on_events_change() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.as_uuid_array(anyelement) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.create_auth_user_for_profile() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.dbg_accept_invite_sim(uuid, uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.debug_get_caller_info() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.debug_list_pg_triggers_profiles() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.debug_list_profiles_triggers() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.delete_event_json(jsonb) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.fn_set_program_exercise_notes() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_company_by_id(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_event_attendee_profiles(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_events_for_company(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profile_by_user(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  ...
  BEGIN ALTER FUNCTION public.get_profiles_by_role_for_clients() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profiles_by_role_for_clients(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profiles_by_role_for_clients(text, uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profiles_by_role_for_professionals(text) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profiles_by_role_for_professionals(text, uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.get_profiles_for_professionals() SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.is_profile_admin_of(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.is_profile_member_of(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.is_professional_of_company(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.is_same_company(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.is_member_of_company(uuid) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.insert_event_json(jsonb) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
  BEGIN ALTER FUNCTION public.update_event_json(jsonb) SET search_path = 'public, pg_temp'; EXCEPTION WHEN undefined_function THEN NULL; END;
END $$;
