...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='Delete own profile') THEN
    EXECUTE $$CREATE POLICY "Delete own profile" ON public.profiles FOR DELETE USING ((auth.uid() = user) OR (auth.uid() = id));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='Enable insert for authenticated users only') THEN
    EXECUTE $$CREATE POLICY "Enable insert for authenticated users only" ON public.profiles FOR INSERT TO authenticated WITH CHECK (true);$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='Select owner or company') THEN
    EXECUTE $$CREATE POLICY "Select owner or company" ON public.profiles FOR SELECT USING ((auth.uid() = user) OR (auth.uid() = id) OR public.is_same_company(company));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_delete_professional_same_company_delete') THEN
    EXECUTE $$CREATE POLICY profiles_delete_professional_same_company_delete ON public.profiles FOR DELETE USING ((EXISTS (SELECT 1 FROM public.profiles p2 WHERE ((p2.user::text = auth.uid()::text) AND (p2.role = 'professional'::text) AND (p2.company::text = profiles.company::text)))));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_policy_delete_admins') THEN
    EXECUTE $$CREATE POLICY profiles_policy_delete_admins ON public.profiles FOR DELETE USING (public.is_profile_admin_of(company));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_policy_select_company_members') THEN
    EXECUTE $$CREATE POLICY profiles_policy_select_company_members ON public.profiles FOR SELECT USING ((user = auth.uid()) OR public.is_profile_member_of(company));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_policy_update_company_members') THEN
    EXECUTE $$CREATE POLICY profiles_policy_update_company_members ON public.profiles FOR UPDATE USING ((public.is_profile_member_of(company) OR (user = auth.uid()))) WITH CHECK ((public.is_profile_member_of(company) OR (user = auth.uid())));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_update_admins_or_professionals') THEN
    EXECUTE $$CREATE POLICY profiles_update_admins_or_professionals ON public.profiles FOR UPDATE USING (((auth.role() = 'service_role'::text) OR (EXISTS (SELECT 1 FROM public.profiles p WHERE ((p.id = auth.uid()) AND ((p.role = 'professional'::text) OR (p.role = 'admin'::text))))))) WITH CHECK (((auth.role() = 'service_role'::text) OR (EXISTS (SELECT 1 FROM public.profiles p WHERE ((p.id = auth.uid()) AND ((p.role = 'professional'::text) OR (p.role = 'admin'::text)))))));$$;
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_update_own') THEN
    EXECUTE $$CREATE POLICY profiles_update_own ON public.profiles FOR UPDATE USING ((auth.uid()::text = USER::text)) WITH CHECK ((auth.uid()::text = USER::text));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_update_professional_same_company_update') THEN
    EXECUTE $$CREATE POLICY profiles_update_professional_same_company_update ON public.profiles FOR UPDATE USING ((EXISTS (SELECT 1 FROM public.profiles p2 WHERE ((p2.user::text = auth.uid()::text) AND (p2.role = 'professional'::text) AND (p2.company::text = profiles.company::text))))) WITH CHECK ((EXISTS (SELECT 1 FROM public.profiles p2 WHERE ((p2.user::text = auth.uid()::text) AND (p2.role = 'professional'::text) AND (p2.company::text = profiles.company::text)))));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='profiles' AND policyname='profiles_update_self_or_service') THEN
    EXECUTE $$CREATE POLICY profiles_update_self_or_service ON public.profiles FOR UPDATE USING (((auth.role() = 'service_role'::text) OR ((auth.uid() = user) OR (auth.uid() = id)) OR public.is_same_company(company))) WITH CHECK (((auth.role() = 'service_role'::text) OR ((auth.uid() = user) OR (auth.uid() = id)) OR public.is_same_company(company)));$$;
  END IF;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='companies' AND policyname='Select company for members') THEN
    EXECUTE $$CREATE POLICY "Select company for members" ON public.companies FOR SELECT USING (public.is_same_company(id));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='companies' AND policyname='allow_select_companies_for_members') THEN
    EXECUTE $$CREATE POLICY "allow_select_companies_for_members" ON public.companies FOR SELECT USING (public.is_member_of_company(id));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='companies' AND policyname='companies_select_company_members') THEN
    EXECUTE $$CREATE POLICY companies_select_company_members ON public.companies FOR SELECT USING (public.is_profile_member_of(id));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='companies' AND policyname='companies_select_member') THEN
    EXECUTE $$CREATE POLICY companies_select_member ON public.companies FOR SELECT USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.id = auth.uid()) AND (p.company = companies.id))));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='companies' AND policyname='companies_update_professional') THEN
    EXECUTE $$CREATE POLICY companies_update_professional ON public.companies FOR UPDATE USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.id = auth.uid()) AND (p.role = 'professional'::text) AND (p.company = companies.id)))) WITH CHECK (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.id = auth.uid()) AND (p.role = 'professional'::text))));$$;
  END IF;
END
$$;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='classes_templates' AND policyname='delete_classes_templates_by_professional') THEN
    EXECUTE $$CREATE POLICY delete_classes_templates_by_professional ON public.classes_templates FOR DELETE TO authenticated USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.user = auth.uid()) AND (p.company = classes_templates.company) AND (p.role = 'professional'::text))));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='classes_templates' AND policyname='insert_classes_templates_by_professional') THEN
    EXECUTE $$CREATE POLICY insert_classes_templates_by_professional ON public.classes_templates FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.user = auth.uid()) AND (p.company = classes_templates.company) AND (p.role = 'professional'::text))));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='classes_templates' AND policyname='select_classes_templates_by_company') THEN
    EXECUTE $$CREATE POLICY select_classes_templates_by_company ON public.classes_templates FOR SELECT TO authenticated USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.user = auth.uid()) AND (p.company = classes_templates.company))));$$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='classes_templates' AND policyname='update_classes_templates_by_professional') THEN
    EXECUTE $$CREATE POLICY update_classes_templates_by_professional ON public.classes_templates FOR UPDATE TO authenticated USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.user = auth.uid()) AND (p.company = classes_templates.company) AND (p.role = 'professional'::text)))) WITH CHECK (EXISTS ( SELECT 1 FROM public.profiles p WHERE ((p.user = auth.uid()) AND (p.company = classes_templates.company) AND (p.role = 'professional'::text))));$$;
  END IF;
END
$$;

-- 6) events policies (including complex select_events_by_company_and_role)
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'events' AND policyname = 'Select owner or company') THEN
    EXECUTE $$CREATE POLICY "Select owner or company" ON public.events FOR SELECT USING (public.is_same_company(company));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'events' AND policyname = 'Update owner or company') THEN
    EXECUTE $$CREATE POLICY "Update owner or company" ON public.events FOR UPDATE USING (public.is_same_company(company)) WITH CHECK (public.is_same_company(company));$$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='events' AND policyname='select_events_by_company_and_role') THEN
    EXECUTE $$CREATE POLICY select_events_by_company_and_role ON public.events FOR SELECT TO authenticated USING (EXISTS ( SELECT 1 FROM public.profiles p WHERE p.user = auth.uid() AND p.company = events.company AND (p.role = 'professional'::text OR (p.role = 'client'::text AND (events.type = 'class'::text OR (events.type = 'appointment'::text AND (p.id = ANY (events.client) OR p.user = ANY (events.client))))))));$$;
  END IF;
END
$$;
