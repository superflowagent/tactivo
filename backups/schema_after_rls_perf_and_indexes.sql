...
CREATE POLICY "Company members can delete" ON "public"."anatomy" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "anatomy"."company")))));



CREATE POLICY "Company members can delete" ON "public"."equipment" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "equipment"."company")))));



CREATE POLICY "Company members can delete" ON "public"."exercises" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "exercises"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));



CREATE POLICY "Company members can delete" ON "public"."program_exercises" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."id" = "program_exercises"."program")))
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "prog"."company") AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))));



CREATE POLICY "Company members can delete" ON "public"."programs" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "programs"."company")))));



CREATE POLICY "Company members can insert" ON "public"."program_exercises" TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."id" = "program_exercises"."program")))
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "prog"."company")))));



CREATE POLICY "Company members can insert" ON "public"."programs" TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "programs"."company")))));



CREATE POLICY "Company members can select" ON "public"."program_exercises" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
...
CREATE POLICY "Company members can select" ON "public"."programs" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "programs"."company")))));



CREATE POLICY "Company members can update" ON "public"."anatomy" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can update" ON "public"."equipment" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can update" ON "public"."exercises" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can update" ON "public"."program_exercises" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."company" = "p"."company")))
...
CREATE POLICY "Company members can update" ON "public"."programs" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."profiles" TO "authenticated" WITH CHECK ((("user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) OR ("user" IS NULL)));
...
CREATE POLICY "combined_anatomy_ALL_24c868726485fb7f398a79147c9c1ea9" ON "public"."anatomy" TO "authenticated", "service_role" USING (((( SELECT ( SELECT "auth"."role"() AS "role") AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "anatomy"."company")))))) WITH CHECK (((( SELECT ( SELECT "auth"."role"() AS "role") AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."role" = 'professional'::"text")))) OR ("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_anatomy_SELECT_2ecc23b8146f11c470d0f0d5b4275825" ON "public"."anatomy" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_equipment_ALL_4610b750e75692447e89fafe3e6d5685" ON "public"."equipment" TO "authenticated", "service_role" USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "equipment"."company")))))) WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_equipment_SELECT_eba253d9f45a68c257a648bb4c10d8ce" ON "public"."equipment" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_events_ALL_fd98b4c831b505ef7cc41baf69516042" ON "public"."events" TO "authenticated", "service_role" WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_events_DELETE_be05ee54cf0a914847cf75a05cca462e" ON "public"."events" FOR DELETE TO "authenticated", "service_role" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_events_SELECT_c5803103649699381bff8e3af805b317" ON "public"."events" FOR SELECT TO "authenticated" USING (("public"."is_same_company"("company") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  ...
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company")))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company") AND (("p"."role" = 'professional'::"text") OR (("p"."role" = 'client'::"text") AND (("events"."type" = 'class'::"text") OR (("events"."type" = 'appointment'::"text") AND (("p"."id" = ANY ("events"."client")) OR ("p"."user" = ANY ("events"."client"))))))))))));



CREATE POLICY "combined_events_UPDATE_9a18e5870689b8eb1650f5b5a636fcdf" ON "public"."events" FOR UPDATE TO "authenticated", "service_role" USING (("public"."is_same_company"("company") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company")))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company")))) OR ((( SELECT ( SELECT "auth"."role"() AS "role") AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "events"."company"))))))) WITH CHECK (("public"."is_same_company"("company") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company")))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "events"."company")))) OR ((( SELECT ( SELECT "auth"."role"() AS "role") AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
...
CREATE POLICY "combined_exercises_ALL_232c3a4d4340be1cb0aa1926c52d13b7" ON "public"."exercises" TO "authenticated", "service_role" USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "exercises"."company")))))) WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text")))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "exercises"."company"))))));



CREATE POLICY "combined_exercises_SELECT_0c286cf94ff6e843601a2d62f9644171" ON "public"."exercises" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "combined_profiles_DELETE_9330d3157aa1a3953e263b5b487994d9" ON "public"."profiles" FOR DELETE TO "authenticated" USING (("public"."is_profile_admin_of"("company") OR ((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id")) OR (EXISTS ( SELECT 1
...
CREATE POLICY "combined_profiles_SELECT_c43d1ed0fe3a9e43d3702f4bc9deb03c" ON "public"."profiles" FOR SELECT TO "authenticated" USING (((( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user") OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "id") OR "public"."is_same_company"("company") OR ((( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user") OR "public"."is_profile_member_of"("company"))));



CREATE POLICY "combined_profiles_UPDATE_3e4f1a491a227d564ecbecd4f2376433" ON "public"."profiles" FOR UPDATE TO "authenticated", "service_role" USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p2"
  WHERE ((("p2"."user")::"text" = (( SELECT "auth"."uid"() AS "uid"))::"text") AND ("p2"."role" = 'professional'::"text") AND (("p2"."company")::"text" = ("profiles"."company")::"text")))) OR ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR ((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id")) OR "public"."is_same_company"("company")) OR ((( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user") OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "id")) OR ("public"."is_profile_member_of"("company") OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user")) OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user"))) WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND (("p"."role" = 'professional'::"text") OR ("p"."role" = 'admin'::"text"))))) OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p2"
  WHERE ((("p2"."user")::"text" = (( SELECT "auth"."uid"() AS "uid"))::"text") AND ("p2"."role" = 'professional'::"text") AND (("p2"."company")::"text" = ("profiles"."company")::"text")))) OR ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR ((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id")) OR "public"."is_same_company"("company")) OR ((( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user") OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "id")) OR ("public"."is_profile_member_of"("company") OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user")) OR (( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid") = "user")));
...
CREATE POLICY "insert_classes_templates_by_professional" ON "public"."classes_templates" TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "classes_templates"."company") AND ("p"."role" = 'professional'::"text")))));
...
CREATE POLICY "select_classes_templates_by_company" ON "public"."classes_templates" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "classes_templates"."company")))));
...
CREATE POLICY "update_classes_templates_by_professional" ON "public"."classes_templates" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "classes_templates"."company") AND ("p"."role" = 'professional'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT ( SELECT "auth"."uid"() AS "uid") AS "uid")) AND ("p"."company" = "classes_templates"."company") AND ("p"."role" = 'professional'::"text")))));
