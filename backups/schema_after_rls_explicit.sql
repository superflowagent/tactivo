...
CREATE POLICY "Company members can insert" ON "public"."anatomy" FOR INSERT TO "authenticated" WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
...
CREATE POLICY "Company members can insert" ON "public"."equipment" FOR INSERT TO "authenticated" WITH CHECK (("company" = ( SELECT "p"."company"
   FROM "public"."profiles" "p"
  WHERE ("p"."user" = ( SELECT "auth"."uid"() AS "uid"))
 LIMIT 1)));
...
CREATE POLICY "Company members can insert" ON "public"."exercises" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "exercises"."company")))));



CREATE POLICY "Company members can insert" ON "public"."program_exercises" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."profiles" "p"
     JOIN "public"."programs" "prog" ON (("prog"."id" = "program_exercises"."program")))
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "prog"."company")))));



CREATE POLICY "Company members can insert" ON "public"."programs" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "programs"."company")))));
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."profiles" FOR INSERT TO "authenticated" WITH CHECK ((("user" = ( SELECT "auth"."uid"() AS "uid")) OR ("user" IS NULL)));
...
CREATE POLICY "Select owner or company" ON "public"."profiles" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id") OR "public"."is_same_company"("company")));



CREATE POLICY "Update own profile" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id"))) WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "user") OR (( SELECT "auth"."uid"() AS "uid") = "id")));
...
CREATE POLICY "anatomy_select_company" ON "public"."anatomy" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "anatomy"."company")))));



CREATE POLICY "anatomy_write_company" ON "public"."anatomy" TO "authenticated", "service_role" USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "anatomy"."company")))))) WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
CREATE POLICY "events_policy_select" ON "public"."events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company")))));



CREATE POLICY "events_policy_update" ON "public"."events" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company")))));



CREATE POLICY "events_select_company_member" ON "public"."events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company")))));



CREATE POLICY "events_select_company_members" ON "public"."events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company")))));



CREATE POLICY "events_update_company_members" ON "public"."events" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."user" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."company" = "events"."company")))));
...
CREATE POLICY "events_update_professional_or_service" ON "public"."events" FOR UPDATE TO "authenticated", "service_role" USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text") AND ("p"."company" = "events"."company")))))) WITH CHECK (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
  WHERE (("p"."id" = ( SELECT "auth"."uid"() AS "uid")) AND ("p"."role" = 'professional'::"text"))))));
...
CREATE POLICY "profiles_policy_select_company_members" ON "public"."profiles" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user") OR "public"."is_profile_member_of"("company")));



CREATE POLICY "profiles_policy_update_company_members" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("public"."is_profile_member_of"("company") OR (( SELECT "auth"."uid"() AS "uid") = "user"))) WITH CHECK (("public"."is_profile_member_of"("company") OR (( SELECT "auth"."uid"() AS "uid") = "user")));
...
CREATE POLICY "profiles_update_own" ON "public"."profiles" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user"));
